...
func SQLITE3(file *os.File) (*parse.ParsedLayout, error) {
...
func parseSQLITE3(file *os.File) (*parse.ParsedLayout, error) {

	pos := int64(0)
	textEncoding, _ := parse.ReadUint32be(file, pos+56)
	textEncodingName := ""
