...
func parseSWF(file *os.File) (*ParsedLayout, error) {
	...
	res := ParsedLayout{
		...
		Layout: []Layout{{
			...
			Type:   Group,
			Childs: []Layout{
				{Offset: pos, Length: 3, Info: "magic", Type: ASCII}, // F = uncompressed, C = zlib compressed, Z = LZMA compressed
				{Offset: pos + 3, Length: 1, Info: "version", Type: Uint8},
				{Offset: pos + 4, Length: 4, Info: "file length", Type: Uint32le},
				...
				{Offset: pos + 8, Length: 2, Info: "frame size", Type: Uint16le},

				{Offset: pos + 10, Length: 2, Info: "frame rate", Type: Uint16le},
				{Offset: pos + 12, Length: 2, Info: "frame count", Type: Uint16le},
			}}}}
